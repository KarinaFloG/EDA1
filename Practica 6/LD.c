...
while (1)
	{
		...
		switch (opcion) {
			...
			case 1:
				...
				fflush(stdin);
				scanf("%c", &val);
				DL_InsertBack(ListaDoble, val);
				break;

			case 2:
				printf ("Retirando el valor:\n");
				printf ("El valor es: %c\n\n",DL_RemoveFront(ListaDoble));
				break;
			...
			case 3:
				...
				fflush(stdin);
				scanf("%c", &val);
				DL_InsertFront(ListaDoble, val);
				break;

			case 4:
				printf ("Retirando el valor\n");				
				printf ("El valor es: %c\n\n",DL_RemoveBack(ListaDoble));
				break;
				
			case 5:
				DL_IsEmpty(ListaDoble);
				break;
				
			case 6:
				DL_IsFull(ListaDoble);
				break;
